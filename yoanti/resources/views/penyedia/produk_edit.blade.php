...
@section('content')
    ...
    <div class="form-container">
        ...
        <form action="{{ url('/penyedia/produk/update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="file-upload-wrapper" id="dropArea">
                    ...
                    <div class="file-upload-content" id="uploadContent" @if(isset($product['image']) && $product['image']) style="opacity: 0;" @endif>
                        ...
                        <div class="file-upload-text">Klik atau seret gambar baru untuk mengganti</div>
                        <div class="file-upload-hint">Maksimal 5MB (JPEG, PNG, GIF)</div>
                    </div>
                    <img id="imagePreview" class="image-preview" alt="Preview" @if(isset($product['image']) && $product['image']) src="{{ asset($product['image']) }}" style="display: block;" @endif>
                </div>
