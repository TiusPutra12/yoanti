...
<style>
    ...
    .sa-stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem; }
    .sa-stat-card {
    ...
    .sa-stat-card h3 { font-size: 3rem; color: var(--primary); margin-bottom: 0.5rem; }
    .sa-stat-card p { color: var(--text-muted); font-weight: 600; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.5px; }
</style>
@endpush
